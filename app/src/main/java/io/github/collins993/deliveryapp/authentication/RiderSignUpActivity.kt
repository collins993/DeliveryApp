...
import io.github.collins993.deliveryapp.databinding.ActivityRiderLoginBinding
import io.github.collins993.deliveryapp.databinding.ActivityRiderSignUpBinding
...
class RiderSignUpActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityRiderSignUpBinding
    private lateinit var viewModel: MyViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRiderSignUpBinding.inflate(layoutInflater)
                ...
                when (it) {
                    is Resource.Success -> {
                        ...
                        if (it.data.equals("UserCreated")) {
                            Toast.makeText(this, "User Successful created", Toast.LENGTH_SHORT)
                                .show()
